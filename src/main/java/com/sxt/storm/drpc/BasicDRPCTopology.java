...
public class BasicDRPCTopology {
	...
	public static class ExclaimBolt extends BaseBasicBolt {
		...
		public void execute(Tuple tuple, BasicOutputCollector collector) {
			String args = tuple.getString(1);
			System.err.println(" data :" + args);
			System.err.println("id: " + tuple.getValue(0));
            //数据处理
            String result = args + "!！@！@！#@#￥%%";
	...
	public static void main(String[] args) throws Exception {
		LinearDRPCTopologyBuilder builder = new LinearDRPCTopologyBuilder("tw");
		...
		if (args == null || args.length == 0) {
			...
			//DRPCSpout , PrepareBolt , myBolt , joinBolt ,resultBolt

			cluster.submitTopology("drpc-demo", conf, builder.createLocalTopology(drpc));
			
			for (String word : new String[] { "hello", "goodbye" }) {

                String result = drpc.execute("tw", word);

                System.err.println("Result for \"" + word + "\": " + result);
			}
