...
import com.sxt.transformer.mr.active.ActiveUserMapper;
import com.sxt.transformer.mr.active.ActiveUserReducer;
 ...
 *
 */
public class Active2UserRunner implements Tool {
	private static final Logger logger = Logger.getLogger(Active2UserRunner.class);
	...
	public static void main(String[] args) {
		try {
			args = new String[]{"-d", "2019-10-08"};
			ToolRunner.run(new Configuration(), new Active2UserRunner(), args);
		} catch (Exception e) {
	...
	public void setConf(Configuration conf) {
		...
		conf.set("hbase.zookeeper.quorum", "basenode201,basenode202,basenode203");
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(Active2UserRunner.class);
		// 本地运行
		TableMapReduceUtil.initTableMapperJob(initScans(job), 
				Active2UserMapper.class,
				StatsUserDimension.class,
				TimeOutputValue.class,
				job, 
				false);

		job.setReducerClass(Active2UserReducer.class);
